...
<sub>Stats and cards are generated from public GitHub data by <a href="scripts/build_profile.py">scripts/build_profile.py</a> and refreshed daily by GitHub Actions. Last update: 25 Sep 2026.</sub>
